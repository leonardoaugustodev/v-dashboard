<template>
  <div class="panel">
    <div class="card card--front">
      <div class="card__name">Nubank</div>
      <div class="card__number">**** **** **** 6359</div>
      <div class="card__expiry-date">xx/xx</div>
      <div class="card__owner">{{ userStore.user.displayName || '' }}</div>
...
const {name, amount} = defineProps(['name', 'amount'])
...
.card {
  ...
  background: linear-gradient(315deg, hsl(290, 86%, 10%) 0%, hsl(290, 86%, 25%) 35%, hsl(290, 86%, 50%) 100%);
